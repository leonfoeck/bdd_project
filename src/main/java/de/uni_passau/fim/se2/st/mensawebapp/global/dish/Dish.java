...
public record Dish(
     ...
     *
     * <p>Note that you have to fill at least the values {@link #type}, {@link #name}, {@link #price},
     * and {@link #date}.
     */
    public static class Builder {
        ...
        /**
         * Sets the price of the {@link Dish}.
         *
         * @param pPrice The new price, must be greater or equal than 0
         * @return The instance of the builder
         */
        public Builder setPrice(final BigDecimal pPrice) {
        ...
        public Dish build() {
            ...
            return new Dish(type, name, additives, allergens, tags, price, date);
        }
    }
}
